...
#  Description: Testing functions added to the Node and Tree classes 
...
# Date Last Modified: 14 April 2018
...
def main():
  ...
  # Get the total number of nodes of the binary search tree
  print("The number of nodes in tree_B is: ", tree_B.num_nodes())
  print("The number of nodes in tree_C is: ", tree_C.num_nodes())
  print("Total number of nodes is: ", tree_B.num_nodes() + tree_C.num_nodes())
