...
#  Description: To simulate a game of Blackjack using classes and object-oriented programming
...
# Date Last Modified: 17 February 2018
    ...
    # do not output result for dealer
        for i in range(len(playerPoints)):
            if (playerPoints[i] > 21):
                ...
                if (dealerPoints > 21 and playerPoints[i] <=21): 
                ...
                a = self.Players[i].hasBlackjack()
                b = self.dealer.hasBlackjack()
